...
v0.1.6 exposes ten tools to Claude:  
...
| `get_audio`       | "listen" — summarize the last N seconds (default 4): level stats, brightness, texture, pitch, onsets, rms/centroid time-series |
